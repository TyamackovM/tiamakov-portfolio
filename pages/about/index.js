            ...
            {aboutData.map((item, itemIndex) => {
              return (
                <div
                  ...
                  className={
                    index === itemIndex
                      ? "text-accent after:w-[100%] after:bg-accent after:transition-all after:duration-300 cursor-pointer capitalize xl:text-lg relative after:absolute after:-bottom-1 after:left-0 after:h-[2px]"
